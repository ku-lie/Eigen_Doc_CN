...
![](http://latex.codecogs.com/svg.latex?a^T)，共轭![](http://latex.codecogs.com/svg.latex?\bar{a})，和伴随（即共轭转置）![](http://latex.codecogs.com/svg.latex?a^*)分别由成员函数transpose()、conjugate(), 和adjoint()
