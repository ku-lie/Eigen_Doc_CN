...
![](http://latex.codecogs.com/svg.latex?a^T)，共轭![](http://latex.codecogs.com/svg.latex?\bar{a})，和伴随（即共轭转置）![](http://latex.codecogs.com/svg.latex?a^*)分别由成员函数[transpose()](14_参考/1_核心模块/18_DenseBase.md#transpose-12)、[conjugate()](#矩阵和向量运算法则), 和[adjoint()](14_参考/1_核心模块/34_MatrixBase.md#adjoint)获得。
